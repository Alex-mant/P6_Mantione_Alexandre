...
// Création d'une boucle afin de creer du contenu HTML pour chaque itération des objets contenu dans les données récuperés
    document.querySelector('.photographer_section').innerHTML = fisheyeData.map((photographer) =>
     `
    <article class="index-card">
        <img class="index-profile" alt="${photographer.name}" src="${photographer.portrait}"></img>
