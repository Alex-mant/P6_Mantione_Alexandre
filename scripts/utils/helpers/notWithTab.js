...
export const notWithTab = () => {
  ...
  const headerPhotographer = document.querySelector("#photograph-book_header");
  ...
  notWithTabModule2(headerPhotographer);
...
export const withTab = () => {
  ...
  withTabModule2(headerPhotographer);
  withTabModule2(contact);
  withTabModule2(filtre);
  filtre.setAttribute("tabindex", 0);
  headerPhotographer.setAttribute("tabindex", 0);
